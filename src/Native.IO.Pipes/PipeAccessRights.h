...
namespace Native
{
	namespace IO
	{
		namespace Pipes
		{
            ...
            constexpr PipeAccessRights operator &(const PipeAccessRights lhs, const PipeAccessRights rhs) {
                using T = std::underlying_type_t<PipeAccessRights>;
                return static_cast<PipeAccessRights>(static_cast<T>(lhs) & static_cast<T>(rhs));
            }
            ...
            constexpr PipeAccessRights operator~(const PipeAccessRights f) {
                using T = std::underlying_type_t<PipeAccessRights>;
                return static_cast<PipeAccessRights>(~static_cast<T>(f));
            }
		}
	}
}